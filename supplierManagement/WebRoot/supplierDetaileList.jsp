...
<table width="894"  border="1" class="tableStyle" bordercolor="#AAAAAA" align="center">
  ...
  <tr>
    ...
    <td>供应商状态</td>
     <td align="left">
     <input type="text" name="supplier.supplierStatus"  value="${supplier.supplierStatus}" size="18"/>
  ...
  <tr>
    ...
    <tr align="center"><td colspan="6">
    	<!-- <input type="submit" value="提交" onclick="return checkAdd()"> -->
