  		...
  		<table border="1" align="center"  bgcolor="#FFFFFF" style="color: black" bordercolor="#AAAAAA">
  			...
  			<tr><td>
  				...
  				合同状态：<select name="contract.contractState">
   								<option value="<s:property value='#contract.contractState'/>"><s:property value="#contract.contractState"/></option>
   								<option value="待审核">待审核</option>
   								<option value="已结清">已结清</option>
   								<option value="不通过">不通过</option>
   								
   						</select>
   						<%-- <input type="text" name="contract.contractState" value="<s:property value='#contract.contractState'/>" readonly="readonly" size="20"/> --%>
   						&nbsp;&nbsp;&nbsp;&nbsp;
