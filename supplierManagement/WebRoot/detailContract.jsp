...
<html>
  ...
  <body>
  	<form action="updateNewContract" method="post" >
  		...
  		<table border="1" align="center"  bgcolor="#FFFFFF" style="color: black" bordercolor="#AAAAAA">
  			...
  			<tr><td>
   			...
   			<tr><td>
  				<%-- 合同编号：<input type="text" name="contract.contractId" value="<s:property value='#contract.contractId'/>" readonly="readonly"/>&nbsp;&nbsp;&nbsp;&nbsp; --%>
  			...
  			<tr><td>
  				<%-- 业务人员：<input type="text" name="contract.operationPerson" value="<s:property value='#contract.operationPerson'/>"/>&nbsp;&nbsp;&nbsp;&nbsp; --%>
  			...
  			<tr><td>
  				<%-- 单位名称：<input type="text" name="contract.companyName" value="<s:property value='#contract.companyName'/>"/>&nbsp;&nbsp;&nbsp;&nbsp; --%>
   			...
   			<tr><td>
  				...
  				<!-- 支付方式：<input type="text" name="contract.payway"/><br> -->
   			...
   			<tr><td>
  				<!-- 合同内容：<input type="text" name="contract.contractContent" class="ckeditor"/><br> -->
  			...
  			<tr><td>
  				<%-- 合同联系人：<input type="text" name="contract.operator" value="<s:property value='#contract.operator'/>"/> --%>
  	...
  	<input class="input-button" type="reset" value="重置" />&nbsp; -->
  	<input class="input-button" type="button" value="返回" onclick="javascript:history.go(-1)" >
  		</td></tr>
  	</s:iterator>
  	</s:if>
 </table>
  			...
  			<%-- <s:if test="contract!=null">
  			<s:iterator value="contract" var="contract" status="sta">
  				合同编号：<input type="text" name="contract.contractId" value="<s:property value='#contract.contractId'/>" readonly="readonly"/><br>
  				合同名称：<input type="text" name="contract.contractName" value="<s:property value='#contract.contractName'/>"/><br>
  				合同甲方：<input type="text" name="contract.partyA" value="<s:property value="#contract.partyA"/>"/><br>
  				合同乙方：<input type="text" name="contract.partyB" value="<s:property value="#contract.partyB"/>"/><br>
  				收付类型：<input type="text" name="contract.receiptsPaymentType" value="<s:property value="#contract.receiptsPaymentType"/>"/><br>
  				支付方式：<input type="text" name="contract.payway" value="<s:property value="#contract.payway"/>"/><br>
  				支付方式：<select name="contract.payway">
  					<option><s:property value="#contract.payway"/></option>
  					<option>现金</option>
  					<option>支票</option>
  				</select><br/>
  				交易币种：<input type="text" name="contract.currency" value="<s:property value="#contract.currency"/>"/><br>
  				合同总价：<input type="text" name="contract.contractPrice" value="<s:property value="#contract.contractPrice"/>"/><br>
  				合同内容：<input type="text" name="contract.contractContent" value="<s:property value="#contract.contractContent"/>"/><br>
  				合同内容：<textarea id="MyTextarea" rows="8" cols="15" name="contract.contractContent">
  				</textarea><br>
  				登记日期：<input type="text" name="contract.registerDate" onclick="WdatePicker()" value="<s:property value="#contract.registerDate"/>"/><br>
  				签订日期：<input type="text" name="contract.signDate" onclick="WdatePicker()" value="<s:property value="#contract.signDate"/>"/><br>
  				开始日期：<input type="text" name="contract.startDate" onclick="WdatePicker()" value="<s:property value="#contract.startDate"/>"/><br>
  				截止日期：<input type="text" name="contract.endDate" onclick="WdatePicker()" value="<s:property value="#contract.endDate"/>"/><br>
  				合同状态：<input type="text" name="contract.contractState" value="<s:property value="#contract.contractState"/>"/><br>
  				单位名称：<input type="text" name="contract.companyName" value="<s:property value="#contract.companyName"/>"/><br>
  				合同备注：<input type="text" name="contract.contractRemark" value="<s:property value="#contract.contractRemark"/>"/><br>
  				合同联系人：<input type="text" name="contract.operator" value="<s:property value="#contract.operator"/>" /><br>
  				甲方责任人：<input type="text" name="contract.partyAprincipal" value="<s:property value="#contract.partyAprincipal"/>"/><br>
  				乙方责任人：<input type="text" name="contract.partyBprincipal" value="<s:property value="#contract.partyBprincipal"/>"/><br>
  				附件：<input type="file" name="contract.attachment" value="<s:property value="#contract.attachment"/>"/><br>
  	<input type="submit" value="修改合同" onblur="javascript:window.opener.location.reload();window.close()"/><input type="reset" value="重置"/>
  		</s:iterator>
  		</s:if> --%>
  	</form>
  </body>
