...
/* 	window.open("addContacter.action"); 
  ...
  <!-- 获取当前时间 ，格式为xxxx-xx-xx -->
    ...
    <s:form method="post" id="addSupp" action="addSupplier" onsubmit="">
    <h4 align="center">添加供应商</h4>
<table width="894"  border="1" class="tableStyle" bordercolor="#AAAAAA" align="center">
	<tr><td colspan="1">供应商类型:</td>
	<td colspan="5" align="left">
  	一级分类:
  	<select id='provinces' name="supplier.bigSort" class="pclass"></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	二级分类:
  	<select id="cities" name="supplier.sort" class="cclass"></select>
  ...
  <tr>
    ...
    <td  colspan="3"  align="left"><label>
      <input name="supplier.supplierName" id="supplierId" type="text" size="65" />
    </label></td>
    <td width="122" >来访日期</td>
    <td width="158"  align="left"><label>
      <input name="supplier.inputDate" type="text" size="18" onclick="WdatePicker()" value="<s:property value='#todayTime'/>" />
    </label></td>
  </tr>
  <tr>
    <td>联系人</td>
    <td width="145" align="left"><input name="supplier.contacter" type="text" size="18" /></td>
    <td width="133">联系电话</td>
    <td width="149" align="left"><input name="supplier.tel" type="text" size="18" /></td>
    <td width="122">公司传真</td>
    <td width="158" align="left"><input name="supplier.fax" type="text" size="18" /></td>
  </tr>
  <tr>
    <td>公司邮箱</td>
    <td align="left"><input name="supplier.email" type="text" size="18" /></td>
    <td>公司网址</td>
    <td align="left"><input name="supplier.website" type="text" size="18" /></td>
    <td>所属行业</td>
  ...
  <tr>
    <td>联系地址</td>
    <td colspan="3" align="left"><input name="supplier.companyAddr" type="text" size="65" /></td>
    <td>供应商状态</td>
     <td align="left">
  ...
  <tr>
    <td>法人代表</td>
    <td align="left"><input name="supplier.legalPerson" type="text" size="18" /></td>
    <td>注册资金</td>
    ...
    <td>品牌名称</td>
    <td align="left"><input name="supplier.brandName" type="text" size="18" /></td>
  </tr>
  <tr>
    <td>企业规模</td>
  ...
  <tr>
    <td>资源优势</td>
    <td colspan="5" align="left"><textarea name="supplier.advantage" cols="85"></textarea></td>
  </tr>
  <tr>
    <td>专长业务</td>
    <td colspan="5" align="left"><textarea name="supplier.speciality" cols="85"></textarea></td>
  </tr>
  <tr>
    <td>覆盖区域</td>
    <td colspan="5" align="left"><textarea name="supplier.area" cols="85"></textarea></td>
  </tr>
  <tr>
    <td>经典案例/重要客户</td>
    <td colspan="5" align="left"><textarea name="supplier.classicCase" cols="85"></textarea></td>
  </tr>
  <tr>
    <td>其他平台合作情况</td>
    <td colspan="5" align="left"><textarea name="supplier.cooperation" cols="85"></textarea></td>
  </tr>
  <tr>
    <td>营业执照编号</td>
    <td  colspan="2" align="left"><input name="supplier.businessLicense" type="text" size="35" /></td>
    <td>营业执照有效期</td>
    <td colspan="2" align="left"><input name="supplier.busLicenseValidity" type="text" size="35" onclick="WdatePicker()"/></td>
  </tr>
  <tr>
    <td>组织机构代码证编号</td>
    <td colspan="2" align="left"><input name="supplier.institutionCertificate" type="text" size="35" /></td>
    <td>组织机构代码证有效期</td>
    <td colspan="2" align="left"><input name="supplier.institutionValidity" type="text" size="35" onclick="WdatePicker()"/></td>
  </tr>
  <tr>
    <td>税务登记证编号</td>
    <td colspan="2" align="left"><input name="supplier.taxCertificateNo" type="text" size="35" /></td>
    <td>开户许可证编号</td>
    <td colspan="2" align="left"><input name="supplier.accountLicense" type="text" size="35" /></td>
  </tr>
  <tr>
    <td>开户行</td>
    <td colspan="2" align="left"><input name="supplier.bank" type="text" size="35" /></td>
    <td>开户银行账号</td>
    <td colspan="2" align="left"><input name="supplier.bankAccount" type="text" size="35" /></td>
  </tr>
  
  <tr>
    <td>备&nbsp;&nbsp;&nbsp;&nbsp;注</td>
    <td colspan="5" align="left"><textarea name="supplier.remark" cols="85"></textarea></td>
  </tr>
